...
class SecondSubCategry : UICollectionViewController , UICollectionViewDelegateFlowLayout {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: self.cell, for: indexPath) as! SecondSubCategryController
        return cell
    ...
    override func viewDidLoad() {
        ...
        collectionView?.register(SecondSubCategryController.self, forCellWithReuseIdentifier: cell)
