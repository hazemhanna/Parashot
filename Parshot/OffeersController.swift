...
class OffeersController  : BaseCell  , UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: self.cell, for: indexPath) as! OffeerView
    ...
    override func setupViews() {
        ...
        collectionView.heightAnchor.constraint(equalTo: heightAnchor,multiplier:0.7).isActive = true
        collectionView.register(OffeerView.self, forCellWithReuseIdentifier: cell)
    ...
    let namelabel :UILabel = {
        ...
        pl.text = NSLocalizedString(" افضل العوض ", comment: "this is name")
        return pl
