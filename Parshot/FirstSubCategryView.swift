...
class FirstSubCategryView: BaseCell,FloatRatingViewDelegate {
    override func setupViews() {
        ...
        horizantalLine.topAnchor.constraint(equalTo: itemPrice.bottomAnchor,constant : 20).isActive = true
        ...
        addToCartBtn.topAnchor.constraint(equalTo: horizantalLine.bottomAnchor,constant : 10).isActive = true
        addToCartBtn.rightAnchor.constraint(equalTo: verticallLine.leftAnchor,constant : -50).isActive = true
