...
class ApiService : NSObject {
    ...
    let baseUrl = NSString(format: "http://parashote.codesroots.com/api")
    ...
    func Register(URL:String,dataarr:[String:String],images:UIImage,completion:@escaping ([String:AnyObject])->()){
        ...
        request.httpBody = createBodyWithParameters(filePathKey: "file", parameters: parameters, imageDataKey: images, boundary: boundary) as Data
