...
class ProuductCardHeadear: BaseCell {
    ...
    override func setupViews() {
        ...
        mainView.addSubview(cartLabe)
        cartLabe.centerYAnchor.constraint(equalTo: mainView.centerYAnchor).isActive = true
        cartLabe.rightAnchor.constraint(equalTo: cartImage.leftAnchor,constant : -5 ).isActive = true
        ////
        mainView.addSubview(totalValueprice)
        totalValueprice.centerYAnchor.constraint(equalTo: mainView.centerYAnchor).isActive = true
        totalValueprice.rightAnchor.constraint(equalTo: cartLabe.leftAnchor).isActive = true
        //////
        mainView.addSubview(ryalLabe)
        ryalLabe.centerYAnchor.constraint(equalTo: mainView.centerYAnchor).isActive = true
        ryalLabe.rightAnchor.constraint(equalTo: totalValueprice.leftAnchor ).isActive = true
        ////////
        mainView.addSubview(buyBtn)
        buyBtn.centerYAnchor.constraint(equalTo: mainView.centerYAnchor).isActive = true
        buyBtn.leftAnchor.constraint(equalTo: mainView.leftAnchor,constant : 10 ).isActive = true
    ...
    let  cartValueLabe :UILabel = {
        ...
        NL.font = font
        NL.translatesAutoresizingMaskIntoConstraints = false
        NL.text = NSLocalizedString(" 3 ", comment: "this is name")
        return NL
    ...
    let  cartLabe :UILabel = {
        let NL = UILabel()
        NL.textColor =  UIColor.rgb(235, green: 69, blue: 105)
        var font = UIFont(name: "JFFlat-Regular", size: 12)
        NL.font = font
        NL.translatesAutoresizingMaskIntoConstraints = false
        NL.text = NSLocalizedString(" اجمالي ثمن المنتجات في السلة", comment: "this is name")
        return NL
    ...
    let  totalValueprice :UILabel = {
        let NL = UILabel()
        NL.textColor =  UIColor.rgb(235, green: 69, blue: 105)
        var font = UIFont(name: "JFFlat-Regular", size: 12)
        NL.font = font
        NL.translatesAutoresizingMaskIntoConstraints = false
        NL.text = NSLocalizedString("1400", comment: "this is name")
        return NL
    ...
    let  buyBtn : UIButton = {
        ...
        button.backgroundColor = UIColor.rgb(65, green: 17, blue: 6)
        button.setTitle(NSLocalizedString(" تاكيد", comment: "this is name"),for: .normal)
