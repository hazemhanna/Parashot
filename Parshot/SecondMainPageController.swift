...
class SecondMainPageController:  UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.item == 0 {
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: Cellid0, for: indexPath) as! SecondDepartmentController
            return cell
        }else if indexPath.item == 1 {
            
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: Cellid1, for: indexPath) as! BestRateController
            ...
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: Cellid2, for: indexPath) as! TypeController
            return cell
    ...
    override func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        case UICollectionElementKindSectionHeader:
            let header = collectionView.dequeueReusableSupplementaryView(ofKind: kind, withReuseIdentifier: self.Headers, for: indexPath as IndexPath) as! SecondSliderController
            return header
    ...
    override func viewDidLoad() {
        ...
        collectionView?.register(SecondDepartmentController.self, forCellWithReuseIdentifier: Cellid0)
        collectionView?.register(BestRateController.self, forCellWithReuseIdentifier: Cellid1)
        collectionView?.register(TypeController.self, forCellWithReuseIdentifier: Cellid2)
        collectionView?.register(SecondSliderController.self, forSupplementaryViewOfKind: UICollectionElementKindSectionHeader, withReuseIdentifier: Headers)
