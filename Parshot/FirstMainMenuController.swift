...
class FirstMainMenuController : UICollectionViewController , UICollectionViewDelegateFlowLayout {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: Cellid0, for: indexPath) as! FirstMenuController
    ...
    override func viewDidLoad() {
        ...
        collectionView?.register(FirstMenuController.self, forCellWithReuseIdentifier: Cellid0)
