...
import UIKit
class FollowOrderController : UICollectionViewController , UICollectionViewDelegateFlowLayout {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
            ...
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: self.cell, for: indexPath) as! FollowOrderView
            return cell
    ...
    override func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        case UICollectionElementKindSectionHeader:
            ...
            header.marketName.text = " متابعة الطلب"
    ...
    override func viewDidLoad() {
        ...
        collectionView?.register(FollowOrderView.self, forCellWithReuseIdentifier: cell)
