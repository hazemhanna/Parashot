...
class FirstMyOrderController : BaseCell, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: self.cell, for: indexPath) as! FirstMyOrderView
    ...
    override func setupViews() {
        ...
        collectionView.register(FirstMyOrderView.self, forCellWithReuseIdentifier: cell)
