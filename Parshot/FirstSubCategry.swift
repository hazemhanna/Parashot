...
class FirstSubCategry : UICollectionViewController , UICollectionViewDelegateFlowLayout {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: self.cell, for: indexPath) as! FirstSubCategryController
        return cell
    ...
    override func viewDidLoad() {
        ...
        collectionView?.register(FirstSubCategryController.self, forCellWithReuseIdentifier: cell)
