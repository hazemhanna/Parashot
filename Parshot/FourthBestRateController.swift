...
class FourthBestRateController  : BaseCell  , UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: self.cell, for: indexPath) as! FourthBestRatesView
    ...
    override func setupViews() {
        ...
        collectionView.register(FourthBestRatesView.self, forCellWithReuseIdentifier: cell)
    ...
    let namelabel :UILabel = {
        ...
        pl.text = NSLocalizedString(" تصفح الافضل تقييما", comment: "this is name")
        return pl
